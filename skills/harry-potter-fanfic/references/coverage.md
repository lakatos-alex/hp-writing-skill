...
Version 0.2.0, developed 2026-09-16.

## Available primary corpus

Seven English Pottermore EPUBs were supplied locally. All 199 primary narrative chapters were imported in EPUB spine order, including the Deathly Hallows epilogue. Front matter and next-book promotional previews were excluded from narrative output.
...
| Extracted text comparison | All primary chapters in local source tests | Normalized text preservation through conversion |
...
Evidence-card locators re-find a phrase in the cited chapter. The source tests check that locators exist, but that alone is not proof that the paraphrase is sound; development included reading surrounding passages. Broad interpretation should be revisited against full chapters when it becomes decisive.
...
The importer supports the supplied edition layout, not arbitrary EPUBs. The chapter catalogue is a retrieval aid, not an exhaustive event chronology, spell dictionary or entity graph. Topic frequency can rank incidental references above decisive evidence.
